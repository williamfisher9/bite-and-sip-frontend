    ...
    return <div className='cards-grid'>
    {
        data.map((item) => {
            return <div className='card-item' key={item.id}>                
                ...
                <div>
                    <p style={{textAlign: "center", margin: "10px 0", fontWeight: "500", fontSize: "18px"}}>{item.userType}</p>
                </div>
                ...
                <div>
                <span className="material-symbols-rounded" style={{border: "2px solid black", borderRadius: "5px", padding: "5px", cursor: "pointer"}}>edit</span>
                </div>
